	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6 service-grid1">
				<a href="application_form.php"><h3>SilverTips Hostel</h3></a>
				<div class="row">
			...
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5 service-grid1">
				<h3>knuckeles Hostel</h3>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>2 yr</h4>
					</div>
					<div class="col-md-9 col-10">
						<p>knuckeles Hostel</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-5 service-grid1">
				<h3>wellawa Hostel</h3>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>3 yr</h4>
					</div>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							...
							<div class="mask">
								<a href="application_form.php?id=A"><img src="web_home/images/s1.png" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for knuckeles-Hostel</h3>
								<p>knuckeles Hostel</p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for wellawa-Hostel</h3>
								<p>wellawa Hostel</p>
							</div>
							<div class="mask">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="https://www.uwu.ac.lk/" target="_blank">UWU <span class="display"> </span></a>
		</div>
